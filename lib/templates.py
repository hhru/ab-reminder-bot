...
SLACK_PAGE_MESSAGE_TEMPLATE = templates_overrides['SLACK_PAGE_MESSAGE_TEMPLATE'] \
    ...
    else u'Привет всем :wave:! {date} у вас будет технологизация, я подготовил страницу, на которой вам нужно рассказать, ' + \
...
SLACK_REMIND_MESSAGE_TEMPLATE = templates_overrides['SLACK_REMIND_MESSAGE_TEMPLATE'] \
    ...
    else u'Привет всем :wave:! Совсем скоро у вас будет технологизация и, насколько я вижу, вы заполнили страницу ' + \
